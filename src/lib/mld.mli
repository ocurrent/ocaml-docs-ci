...
(** [v ~children ~parent t skip] is the command to compile t, potentially 
  having a [parent] and multiple [children] pages. *)
...
module Gen : sig
  ...
  (** A page to generate is described by its content, its mld compilation unit and its 
